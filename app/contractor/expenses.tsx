...
const styles = StyleSheet.create({
  ...
  statValue: { fontSize: 18, fontFamily: 'Manrope_700Bold', color: SemanticColors.textPrimary },
  ...
  vatText: { fontSize: 13, fontFamily: 'Manrope_600SemiBold', color: Palette.hermesOrange },
  ...
  catText: { fontSize: 12, fontFamily: 'Manrope_600SemiBold', color: SemanticColors.textSecondary },
  ...
  expenseInfo: { flex: 1 },
  expenseName: { fontSize: 14, fontFamily: 'Manrope_600SemiBold', color: SemanticColors.textPrimary },
  ...
  expenseAmount: { fontSize: 14, fontFamily: 'Manrope_700Bold', color: SemanticColors.textPrimary },
  ...
  deductText: { fontSize: 10, fontFamily: 'Manrope_600SemiBold', color: SemanticColors.feedbackSuccess },
