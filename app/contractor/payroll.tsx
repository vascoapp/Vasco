...
const styles = StyleSheet.create({
  ...
  summaryValue: { fontSize: 16, fontFamily: 'Manrope_700Bold', color: SemanticColors.textPrimary },
  ...
  grandTotalLabel: { fontSize: 14, fontFamily: 'Manrope_600SemiBold', color: SemanticColors.textSecondary },
  grandTotalValue: { fontSize: 18, fontFamily: 'Manrope_800ExtraBold', color: SemanticColors.textPrimary },
  ...
  avatarText: { fontSize: 13, fontFamily: 'Manrope_700Bold', color: Palette.hermesOrange },
  memberInfo: { flex: 1 },
  memberName: { fontSize: 14, fontFamily: 'Manrope_600SemiBold', color: SemanticColors.textPrimary },
  memberRole: { fontSize: 12, color: SemanticColors.textSecondary, marginTop: 1 },
  memberTotal: { fontSize: 16, fontFamily: 'Manrope_700Bold', color: SemanticColors.textPrimary },
  ...
  detailValue: { fontSize: 13, fontFamily: 'Manrope_600SemiBold', color: SemanticColors.textPrimary },
  ...
  exportBannerTitle: { fontSize: 16, fontFamily: 'Manrope_700Bold', color: '#fff' },
