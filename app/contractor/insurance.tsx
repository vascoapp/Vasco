...
const styles = StyleSheet.create({
  ...
  statCard: {
    flex: 1, alignItems: 'center', backgroundColor: '#fff', borderRadius: 16, paddingVertical: 14, gap: 4,
  },
  ...
  policyInfo: { flex: 1 },
  policyName: { fontSize: 14, fontFamily: 'Inter_600SemiBold', color: '#1A1A1A' },
  ...
  policyAmount: { fontSize: 14, fontFamily: 'Manrope_700Bold', color: '#1A1A1A' },
  emptyState: { alignItems: 'center', paddingVertical: 40, gap: 8 },
  emptyText: { fontSize: 14, color: '#999' },
  // Claims section
  claimsSectionTitle: { fontSize: 16, fontFamily: 'Manrope_700Bold', color: '#1A1A1A', marginBottom: 4 },
  claimCard: { backgroundColor: '#fff', borderRadius: 16, padding: 14, gap: 8, borderLeftWidth: 3, borderLeftColor: SemanticColors.feedbackWarning },
  claimHeader: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  claimPolicyName: { flex: 1, fontSize: 14, fontFamily: 'Inter_600SemiBold', color: '#1A1A1A' },
  ...
  modalContent: { backgroundColor: '#fff', borderTopLeftRadius: 20, borderTopRightRadius: 20, paddingHorizontal: 20, paddingTop: 20, paddingBottom: SafeArea.bottom + 16, maxHeight: '85%' },
  modalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
  modalTitle: { fontSize: 18, fontFamily: 'Manrope_700Bold', color: '#1A1A1A' },
  fieldLabel: { fontSize: 13, fontFamily: 'Inter_600SemiBold', color: '#666', marginBottom: 6, marginTop: 8 },
  fieldInput: { backgroundColor: '#F8F8F6', borderRadius: 12, borderWidth: 1, borderColor: '#EEEEEE', paddingHorizontal: 14, paddingVertical: 10, fontSize: 15, color: '#1A1A1A' },
  policyChip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 8, backgroundColor: '#F5F5F5', borderWidth: 1, borderColor: '#EEE' },
