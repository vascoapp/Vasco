...
const styles = StyleSheet.create({
  ...
  workerName: { fontSize: 15, fontFamily: 'Manrope_600SemiBold', color: SemanticColors.textPrimary },
  ...
  certCount: { fontSize: 13, fontFamily: 'Manrope_600SemiBold', color: SemanticColors.textSecondary },
  ...
  certBadgeText: { fontSize: 11, fontFamily: 'Manrope_600SemiBold' },
});
