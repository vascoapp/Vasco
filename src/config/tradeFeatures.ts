...
export type Trade = 'plumbing' | 'electrical' | 'gas' | 'painting' | 'carpentry' | 'general' | 'other' | 'roofing' | 'tiling' | 'plastering' | 'flooring' | 'insulation' | 'solar' | 'glazing' | 'landscaping';
