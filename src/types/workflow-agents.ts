...
export interface QuoteNurtureWorkflow extends Workflow<QuoteNurtureContext> {
  type: 'quote-nurture';
...
export interface CashCollectionWorkflow extends Workflow<CashCollectionContext> {
...
export interface JobCloseoutWorkflow extends Workflow<JobCloseoutContext> {
  type: 'job-closeout';
...
export interface MaterialReorderWorkflow extends Workflow<MaterialReorderContext> {
