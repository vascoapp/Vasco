// =============================================================================
// CUSTOMER GLOSSARY (web) — plain-language construction terms
// =============================================================================
// Ported verbatim from the mobile app's src/data/customerGlossary.ts so the
// web decision portal's "What do these words mean?" modal matches the app.
// Kept as data (not i18n JSON) so term + definition stay paired.
// =============================================================================

export type GlossaryLang = 'en' | 'nl' | 'de' | 'fr' | 'es' | 'it';

export interface GlossaryEntry {
  id: string;
  term: Record<GlossaryLang, string>;
