...
const COPY = {
  ...
  de: {
    signup: { eyebrow: 'Willkommen bei Vasco', title: 'Sie sind dabei', body: 'Ihre E-Mail wurde bestätigt. Öffnen Sie die Vasco-App, um Ihren Betrieb einzurichten.', cta: 'In der App fortfahren' },
    recovery: { eyebrow: 'Passwort zurücksetzen', title: 'Fast geschafft', body: 'Öffnen Sie die Vasco-App, um ein neues Passwort zu wählen.', cta: 'In der App fortfahren' },
    magiclink: { eyebrow: 'Angemeldet', title: 'Sie sind angemeldet', body: 'Öffnen Sie die Vasco-App, um dort weiterzumachen, wo Sie aufgehört haben.', cta: 'In der App fortfahren' },
    unknown: { eyebrow: 'Vasco öffnen', title: 'In der App fortfahren', body: 'Tippen Sie unten, um in Vasco fortzufahren.', cta: 'In der App fortfahren' },
    opening: 'Vasco wird geöffnet…',
    helper: 'App nicht geöffnet? Tippen Sie auf den Button.',
    noApp: 'Neu bei Vasco? Holen Sie sich die App',
    error: { eyebrow: 'Etwas ist schiefgelaufen', title: 'Dieser Link ist nicht mehr gültig', body: 'Der Link ist abgelaufen oder wurde bereits verwendet. Öffnen Sie die App und fordern Sie einen neuen an.' },
    desktopHint: 'Sie sind am Computer. Öffnen Sie diese E-Mail auf Ihrem Handy oder laden Sie Vasco unten herunter.',
    footer: '© Vasco · vascobuild.com',
  },
  fr: {
