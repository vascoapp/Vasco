...
import { AdminDesignLab } from "@/components/AdminDesignLab";
...
const NAV: NavGroup[] = [
  ...
  },
  {
    title: "Design",
    items: [
      { id: "design-lab", label: "Design Lab", shortcut: "0", icon: <svg className={I} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" /></svg> },
    ],
  },
  {
    title: "Marketing",
  ...
  },
  {
    title: "Content",
    items: [
      { id: "content-machine", label: "Content Machine", shortcut: "6", icon: <svg className={I} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" /></svg> },
      { id: "pipeline", label: "Pipeline", icon: <svg className={I} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" /></svg> },
  ...
  return (
    <div className="flex min-h-[calc(100vh-4rem)] print:block">
      ...
      <main className="flex-1 overflow-y-auto p-6 print:p-0">
        ...
        {activeTab === "design-lab" && <AdminDesignLab />}
      </main>
    </div>
  );
}
